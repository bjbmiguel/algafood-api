...
import com.algaworks.algafood.api.v1.assembler.FormaDePagamanetoInputDisassembler;
...
//				.cacheControl(CacheControl.noCache())
    ...
    public ResponseEntity<Void> remover(@PathVariable Long formaDePagamentoId) {
