...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleTypeMismatchException(MethodArgumentTypeMismatchException ex,
        ...
        String detail = String.format("O parâmetro da URL '%s' recebeu o valor '%s' que é um tipo inváalido. Corrija e informa" +
                " o valor compatível com o tipo '%s'.", ex.getParameter().getParameterName(), ex.getValue().toString(), ex.getRequiredType().getSimpleName());
