...
public class FormaDePagamentoService {
    ...
    @Transactional
    public FormaDePagamento salvar(FormaDePagamento formaDePagamento) { // Vamos usar para salvar e actualizar
        return formaDePagamentoRepository.save(formaDePagamento);
    }

    public FormaDePagamento hasOrNot(Long formaDePagamentoId) {
    ...
    public Optional<FormaDePagamento> buscar(Long formaDePagamentoId) {
